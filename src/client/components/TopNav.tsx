...
import { HamburgerIcon, CloseIcon, AddIcon, ViewIcon, ChevronDownIcon } from '@chakra-ui/icons';
      ...
      <Box bg={useColorModeValue('gray.100', 'gray.900')} px={4}>
        <Flex h={16} alignItems={'center'} justifyContent={'space-between'}>
          ...
          <Flex alignItems={'center'}>
            <Select variant='flushed' maxWidth='140px' colorScheme={'teal'} onChange={updateUserSelector}
